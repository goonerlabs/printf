...
/**
 * print_hex - function that prints the hexadecimal value of an unsigned integer
 * @i: first parameter
 * @...: second parameter
 * Return: count
 */
...
/**
 * print_octal - function that prints the hexadecimal value of an unsigned integer
 * @i: first parameter
 * @...: second parameter
 * Return: count
 */
